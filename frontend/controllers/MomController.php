...
class MomController extends \yii\web\Controller
{
    ...
    public function actionReport5times() {
...
order by distcode,hoscode asc;";
        ...
        return $this->render('report_5times', [
    ...
    public function actionIndivReport5times($hospcode = null, $date1 = '2014-04-01', $date2 = "date('Y-m-d')") {
...
";
        ...
        return $this->render('indiv_report_5times', [
                    'rawData' => $rawData,
                    'sql' => $sql,
        ]);
    }

    public function actionReport12wks() {
...
order by distcode,hoscode asc";
        ...
        return $this->render('report_12wks', [
    ...
    public function actionIndivReport12wks($hospcode = null, $date1 = '2014-04-01', $date2 = "date('Y-m-d')") {
...
";
        ...
        return $this->render('indiv_report_12wks', [
                    'rawData' => $rawData,
                    'sql' => $sql,
        ]);
    }

    public function actionReportlessthan2500g(){
        $date1 = "2014-04-01";
        $date2 = date('Y-m-d');
        if(Yii::$app->request->isPost){
            $date1 = $_POST['date1'];
...
order by distcode,hoscode asc";
        ...
        return $this->render('report_lessthan2500g',[
            'dataProvider' => $dataProvider,
            //'rawData' => $rawData,
            'date1' => $date1,
            'date2' => $date2,
    ...
    public function actionIndivReportLessthan2500g($hospcode = null, $date1 = '2014-04-01', $date2 = "date('Y-m-d')"){
        $sql = "select person.hospcode,person.pid,concat(person.name,'  ',person.lname) as fullname,if(person.sex=1,'ชาย','หญิง') as sex,
TIMESTAMPDIFF(MONTH,person.birth,CURDATE()) as age_y,newborn.bdate , newborn.bweight, if(BWEIGHT < 2500,'n','y') as result
from newborn  
inner join person on newborn.hospcode = person.hospcode and newborn.pid = person.pid 
where person.discharge = '9' and person.typearea in ('1', '3') and person.nation ='099'  
...
and person.hospcode = $hospcode";
        ...
        return $this->render('indiv_report_lessthan2500g',[
            'rawData' => $rawData,
            'sql' => $sql,
        ]);
    }
