...
?>
<?php
$this->title = 'ผู้ป่วยรายใหม่ จาก กลุ่ม PreDM';
$this->params['breadcrumbs'][] = ['label' => 'คัดกรอง', 'url' => ['screen/index']];
$this->params['breadcrumbs'][] = 'ผู้ป่วยรายใหม่ จาก กลุ่ม PreDM';
?>
...
$header = '<i class="glyphicon glyphicon-th-list"></i> ผู้ป่วยรายใหม่ จาก กลุ่ม PreDM ';
